...
def main(args):
    ...
    argsCopy.path = 'checkpoints/iwed_cs_en_0.5/checkpoint300.pt'
    argsCopy.source_lang = 'cs'
    argsCopy.data='../bert-nmt/examples/translation/destdir_cs'
    argsCopy.save_dir = 'checkpoints/iwed_cs_en_0.5'
