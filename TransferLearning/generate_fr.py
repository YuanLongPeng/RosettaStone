...
def main(args):
    ...
    argsCopy.path = 'checkpoints/iwed_fr_en_0.5/checkpoint300.pt'
    argsCopy.source_lang = 'fr'
    argsCopy.data='../bert-nmt/examples/translation/destdir_fr'
    argsCopy.save_dir = 'checkpoints/iwed_fr_en_0.5'
